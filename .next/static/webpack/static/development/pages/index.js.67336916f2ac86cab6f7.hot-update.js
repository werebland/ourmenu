...
var citySelectorPose = {
  collapsed: {
    height: function height(_ref) {
      ...
      return "calc(100vh - ".concat(offsetHeight, "px)");
    }
  },
  expanded: {
    height: '100vh'
...
function MenuFinder(_ref2) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MenuFinderContainer, {
    ...
    onClick: function onClick() {
      return console.log(containerInput.current.offsetHeight);
    },
    __source: {
      fileName: _jsxFileName,
      lineNumber: 113
    ...
    onChange: function onChange(option) {
      return handleCitySelect(option, containerInput.current.offsetHeight);
    },
    __source: {
      fileName: _jsxFileName,
      lineNumber: 116
...
//# sourceMappingURL=index.js.67336916f2ac86cab6f7.hot-update.js.map