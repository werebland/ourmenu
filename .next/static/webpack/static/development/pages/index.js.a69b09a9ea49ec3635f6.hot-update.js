...
var selectStyles = {
  control: function control(styles, _ref2) {
    ...
    return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, styles, {
      borderRadius: 8,
      borderColor: isFocused ? 'rgba(0,0,0,1)' : '#fff',
      boxShadow: isFocused ? '0 0 0 1px rgba(0,0,0,1)' : null,
      fontSize: '2.25rem',
      height: 56,
      width: data,
      fontWeight: 700,
...
function MenuFinder(_ref3) {
  var offsetHeight = _ref3.offsetHeight,
      cities = _ref3.cities,
      city = _ref3.city,
      handleCitySelect = _ref3.handleCitySelect,
      restaurants = _ref3.restaurants,
      handleRestaurantSelect = _ref3.handleRestaurantSelect,
      menu = _ref3.menu;
...
//# sourceMappingURL=index.js.a69b09a9ea49ec3635f6.hot-update.js.map