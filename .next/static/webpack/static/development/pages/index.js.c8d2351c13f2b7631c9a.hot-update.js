...
})(["width:100%;max-width:100vw;min-width:100vw;height:96px;padding:0 32px;box-sizing:border-box;display:flex;flex-flow:row nowrap;justify-content:space-between;align-items:center;position:fixed;top:0;left:0;right:0;z-index:88;"]);
...
})(["border:1px solid ", ";border-radius:8px;appearance:none;background:", ";font-size:1rem;font-weight:700;color:", ";padding:12px 16px;cursor:pointer;transition:padding-left 200ms cubic-bezier(0.0,0,0.2,1) 0ms,border-color 200ms cubic-bezier(0.0,0,0.2,1) 0ms,border-width 200ms cubic-bezier(0.0,0,0.2,1) 0ms;&:hover{background:transparent;border-color:#fff;color:#fff;}"], function (props) {
  return props.inverted ? 'rgba(0,0,0,1)' : '#fff';
}, function (props) {
  return props.inverted ? 'rgba(0,0,0,1)' : '#fff';
}, function (props) {
...
})(["width:420px;padding:16px 0;display:flex;justify-content:flex-start;"]);
...
//# sourceMappingURL=index.js.c8d2351c13f2b7631c9a.hot-update.js.map